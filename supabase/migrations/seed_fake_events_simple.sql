-- Simple Fake Events Seed for Testing
-- This version works without needing existing businesses
-- Just shows how events will look on the calendar

-- Insert Events without requiring business organizers
INSERT INTO events (
  category_id,
  title,
  description,
